...
export const themes = {
  ...
  // Purple and red gradient theme
  purpleRed: {
    id: 'purpleRed',
    name: 'Purple & Red',
    // Background gradients
    appBg: 'linear-gradient(135deg, #c084fc 0%, #ef4444 100%)',
    
    // Navbar styling
    navbarBg: 'white',
    navbarText: '#9333ea', // Purple text on white navbar
    logoText: '#9333ea',
    
    // Footer styling
    footerBg: '#9333ea', // Purple footer
    footerText: 'white', // White text on purple footer for contrast
  ...
  // Green and yellow gradient theme
  greenYellow: {
    id: 'greenYellow',
    name: 'Green & Yellow',
    // Background gradients
    appBg: 'linear-gradient(135deg, #84cc16 0%, #facc15 100%)',
    
    // Navbar styling
    navbarBg: 'white',
    navbarText: '#16a34a', // Green text on white navbar
    logoText: '#16a34a',
    
    // Footer styling
    footerBg: '#16a34a', // Green footer
    footerText: 'white', // White text on green footer for contrast
